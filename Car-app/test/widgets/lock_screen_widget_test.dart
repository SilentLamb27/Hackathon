...
void main() {
  testWidgets('LockScreen owner registration flow registers owner and shows welcome dialog',
      (WidgetTester tester) async {
    SharedPreferences.setMockInitialValues({});

    // Mock flutter_secure_storage platform channel to avoid platform calls in tests
    const MethodChannel secureChannel = MethodChannel('plugins.it_nomads.com/flutter_secure_storage');
